...
export default function Footer() {
 return (
   <main className="text-[clamp(10px,2.5vw,15px)] px-4 w-full items-center justify-center bg-[#222F37] text-white h-46 font-roboto">
        <div className="flex w-full h-40 items-center justify-between max-w-7xl mx-auto">
